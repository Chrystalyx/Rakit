...
export default function ProjectDetail() {
    const [isChatOpen, setIsChatOpen] = useState(false); // State Modal Chat
    const [note, setNote] = useState("");

    // Data Dummy Proyek Detail
    const project = {
        id: 1,
        title: "Kitchen Set Minimalis Type-L",
        client: "Ibu Sarah",
        clientId: 99, // ID User Klien
        clientAvatar: "S",
        ...
        specs: {
            ...
            finishing: "HPL Taco TH-123 (White Glossy)",
        },
        timeline: [
            { stage: "Konfirmasi & DP", date: "20 Nov", status: "completed" },
            {
            ...
            {
                stage: "Fabrikasi (Potong & Rakit)",
                date: "22 Nov",
                status: "completed",
            },
            { stage: "Finishing", date: "Hari Ini", status: "current" },
            {
    ...
    // Format data klien agar sesuai format yang dibutuhkan ChatWindow
    const chatProfile = {
        id: project.clientId,
        name: project.client,
